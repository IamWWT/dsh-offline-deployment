...
/** 预设数据源类型的中文标签。 */
export const PRESET_DATA_SOURCE_LABELS: Record<string, string> = {
  metrics: '指标',
  logs: '日志',
  trace: '调用链',
  cmdb: 'CMDB 变更历史',
...
/** 预设数据源类型的默认查询路径。 */
export const PRESET_DEFAULT_QUERY_PATHS: Record<string, string> = {
...
export const PRESET_SOURCE_TYPES: string[] = ['metrics', 'logs', 'trace', 'cmdb', 'knowledge']
...
export function defaultQueryPathFor(type: string): string {
